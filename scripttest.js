...
for(i=0;i<tiers.length;i++)
{
  if((tiercount==tiers[i].tier)&&(tiers[i].number==1))
  {
    ...
    dDiv.id = 'Display'+tiercount.replace(/\s+/g, '');
    dDiv.className = 'TierDisplay';
    document.getElementById('container').appendChild(dDiv);
  ...
  if(tiers[i].type=='Normal')
  {
       ...
       if(tiers[i].boxcolor=='Blue')
        {
         ...
         iDiv.innerHTML =iDiv.innerHTML + '&lt;!-- Special Reward 1 --&gt;&lt;div class=&quot;reward selected rew_special r_blue&quot; id=&quot;reward_s1&quot;&gt;&lt;img alt=&quot;&quot; class=&quot;rewards1_img&quot; src=&quot;'+tiers[i].icon+'&quot; /&gt;&lt;h3 id=&quot;h3&quot;&gt;'+tiers[i].itemname+'&lt;/h3&gt;&lt;/div&gt;&lt;div class=&quot;reward_info show&quot; id=&quot;reward_info_s1&quot;&gt;&lt;img alt=&quot;&quot; class=&quot;reward_img&quot; src=&quot;'+tiers[i].screenshot+'&quot; /&gt;&lt;div class=&quot;reward_info_details&quot;&gt;&lt;h4 id=&quot;h4&quot;&gt;'+tiers[i].itemname+'&lt;/h4&gt;&lt;img alt=&quot;&quot; class=&quot;ani_pulseon&quot; id=&quot;rewards1_img&quot; src=&quot;'+tiers[i].icon+'&quot;/&gt;&lt;p&gt;'+tiers[i].description+'&lt;/div&gt;&lt;/div&gt;';
          ...
          {
          dDiv.innerHTML =dDiv.innerHTML + '<!-- Special Reward 1 --><div class="reward selected rew_special r_blue" id="reward_s1"><img alt="" class="rewards1_img" src="'+tiers[i].icon+'" /><h3 id="h3">'+tiers[i].itemname+'</h3><div class="reward_recommended"></div></div><div class="reward_info show" id="reward_info_s1"><img alt="" class="reward_img" src="'+tiers[i].screenshot+'" /><div class="reward_info_details"><h4 id="h4">'+tiers[i].itemname+'</h4><img alt="" class="ani_pulseon" id="rewards1_img" src="'+tiers[i].icon+'"/><p>'+tiers[i].description+'</div></div>';
          iDiv.innerHTML =iDiv.innerHTML +'&lt;!-- Special Reward 1 --&gt;&lt;div class=&quot;reward selected rew_special r_blue&quot; id=&quot;reward_s1&quot;&gt;&lt;img alt=&quot;&quot; class=&quot;rewards1_img&quot; src=&quot;'+tiers[i].icon+'&quot; /&gt;&lt;h3 id=&quot;h3&quot;&gt;'+tiers[i].itemname+'&lt;/h3&gt;&lt;/div&gt;&lt;div class=&quot;reward_info show&quot; id=&quot;reward_info_s1&quot;&gt;&lt;img alt=&quot;&quot; class=&quot;reward_img&quot; src=&quot;'+tiers[i].screenshot+'&quot; /&gt;&lt;div class=&quot;reward_info_details&quot;&gt;&lt;h4 id=&quot;h4&quot;&gt;'+tiers[i].itemname+'&lt;/h4&gt;&lt;img alt=&quot;&quot; class=&quot;ani_pulseon&quot; id=&quot;rewards1_img&quot; src=&quot;'+tiers[i].icon+'&quot;/&gt;&lt;p&gt;'+tiers[i].description+'&lt;/div&gt;&lt;/div&gt;';
          }
          ...
          {
          dDiv.innerHTML =dDiv.innerHTML + '<!-- Special Reward 1 --><div class="reward selected rew_special r_blue" id="reward_s1"><img alt="" class="rewards1_img" src="'+tiers[i].icon+'" /><h3 id="h3">'+tiers[i].itemname+'</h3><div class="reward_new ani_pulse2on"></div></div><div class="reward_info show" id="reward_info_s1"><img alt="" class="reward_img" src="'+tiers[i].screenshot+'" /><div class="reward_info_details"><h4 id="h4">'+tiers[i].itemname+'</h4><img alt="" class="ani_pulseon" id="rewards1_img" src="'+tiers[i].icon+'"/><p>'+tiers[i].description+'</div></div>';
          ...
          {
          dDiv.innerHTML =dDiv.innerHTML + '<!-- Special Reward 1 --><div class="reward selected rew_special r_blue" id="reward_s1"><img alt="" class="rewards1_img" src="'+tiers[i].icon+'" /><h3 id="h3">'+tiers[i].itemname+'</h3><div class="reward_recommended"></div><div class="reward_new ani_pulse2on"></div></div><div class="reward_info show" id="reward_info_s1"><img alt="" class="reward_img" src="'+tiers[i].screenshot+'" /><div class="reward_info_details"><h4 id="h4">'+tiers[i].itemname+'</h4><img alt="" class="ani_pulseon" id="rewards1_img" src="'+tiers[i].icon+'"/><p>'+tiers[i].description+'</div></div>';
    ...
    else if(tiers[i].boxtype=='GM Service')
    {
        ...
        {
        dDiv.innerHTML =dDiv.innerHTML + '<!-- Reward 6 -- Example GM Service --><div class="reward unselected rew_hover r_gold" id="reward6" onclick="toggleReward(\'reward_info6\',\'reward6\',\'reward6_img\',\'arrow6\')" onmouseout="toggleAni(\'arrow6\')" onmouseover="toggleAni(\'arrow6\')"><div class="r_arrow arrow_on" id="arrow6"></div><img alt="" class="reward6_img" src="'+tiers[i].icon+'" /><h3 id="h3">GM Service</h3><div class="reward_new ani_pulse2on"></div></div><div class="reward_info hidden" id="reward_info6"><div class="reward_info_details reward_service"><h4 id="h4">'+tiers[i].itemname+'</h4><p>You can ask for any already released item & they are gift-able.</p><p style="font-size:16px; text-shadow: none; color: #496C5E;">Not including: Items released after the June Tiered Spender was released donâ€™t apply. No Full Key or key Fragment.</p><p style="font-size:16px">Simply fill in the following form to request your Item, in case you wish to gift it to a friend, youâ€™ll have the opportunity to put in the account name of the lucky player in the form too.</p><div id="reward_button"><a href="https://docs.google.com/forms/d/1d4SgT2xQ5LtqpO66wWZnjmGLePBW1MiQ3B0S_V1NJ-o/viewform?c=0&w=1">Click here</a></div></div></div>';
  ...
  else if(tiers[i].type=='Package')
  {
   ...
   for(j=i;j<(i+12);j++)
    {
      if((tiers[j].number==(itemnum+1))&&(first_time==0))
      {
       packagesize=count;
       first_time=1; 
      }
     else if((tiers[j].number!=(itemnum+1))||(tiers[j].number==undefined))
      {
       count++; 
      }
    }
